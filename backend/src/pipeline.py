...
# Create MCP server with longer timeout
...
async def run(prompt: str) -> str:
    try:
        ...
        return f"I'm sorry, I encountered an error while processing your request for weather information about '{prompt}'. The weather service might be temporarily unavailable. Please try again later."
